<template>
  <!-- Desktop dock -->
  <aside
    class="hidden w-[360px] min-w-[320px] flex-col rounded-2xl border border-emerald-500/20 bg-slate-950/60 shadow-2xl shadow-emerald-500/10 backdrop-blur-xl lg:flex lg:sticky lg:top-4"
  ...
  >
    <div class="flex items-center justify-between border-b border-slate-800/60 px-4 py-3">
      <div class="flex items-center gap-2 text-sm font-bold text-slate-100">
        <i class="fas fa-store text-emerald-300"></i>
        商城与套餐
      </div>
      <button
...
import { focusArea, marketplaceOpen } from '../shared/uiState';
