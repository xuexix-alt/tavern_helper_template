...
.scope-preview {
  ...
  padding: 10px 12px;
  border-radius: 8px;
  background-color: var(--shelter-scope-preview-bg, var(--shelter-preview-bg));
  color: var(--text-color);
  font-size: 0.9em;
  line-height: 1.4;
...
.scope-modal {
  ...
  max-height: 100%;
  background: var(--shelter-scope-modal-bg, var(--shelter-modal-bg));
  border: 1px solid var(--shelter-surface-border-base);
  border-radius: 14px;
...
.shelter-redesign .metric-number {
  ...
  line-height: 1;
  font-weight: 800;
  color: var(--shelter-metric-number-color, var(--shelter-metric-number-color));
...
.shelter-redesign .map-toggle-btn--scope .toggle-icon {
  color: var(--shelter-scope-btn-icon-color, var(--shelter-scope-toggle-icon));
  font-weight: 900;
}
...
.shelter-redesign .scope-hint {
  ...
  padding: 3px 8px;
  border-radius: 999px;
  background: var(--shelter-scope-hint-bg, var(--shelter-scope-pill-bg));
  color: var(--shelter-scope-hint-color, var(--shelter-scope-pill-text));
  font-size: 0.76em;
}
...
.shelter-redesign .shelter-ability-block .collapse-toggle-btn {
  ...
  background: var(
    ...
    linear-gradient(180deg, var(--shelter-ability-toggle-bg-start), var(--shelter-ability-toggle-bg-end))
  );
...
:global(:root[data-theme='milky']) #shelter-section .map-zone--compact {
  border-color: var(--shelter-light-panel-border);
}
...
:global(:root[data-theme='milky']) #shelter-section .room-cell:not(.occupied):not(.sheltered) {
  border-color: var(--shelter-light-room-border);
  background: linear-gradient(180deg, var(--shelter-light-room-bg-start), var(--shelter-light-room-bg-end));
  box-shadow: inset 0 0 0 1px var(--shelter-light-room-inner-border);
}
...
:global(:root[data-theme='milky']) #shelter-section .room-cell:not(.occupied):not(.sheltered) .room-number::before {
  background: var(--shelter-light-room-dot-bg);
  box-shadow: 0 0 0 2px var(--shelter-light-room-dot-shadow);
}
...
:global(:root[data-theme='milky']) #shelter-section .roll-calibrate-btn {
  border-color: var(--shelter-light-calibrate-border);
  background: var(--shelter-light-calibrate-bg);
  color: var(--shelter-light-calibrate-text);
}
...
:global(:root[data-theme='milky']) #shelter-section .scope-modal-footer {
  border-color: var(--shelter-light-modal-border);
}
...
:global(:root[data-theme='milky']) #shelter-section .scope-room-chip {
  border-color: var(--shelter-light-panel-border);
  background: var(--shelter-light-chip-bg);
  color: var(--text-color);
}
...
:global(:root[data-theme='milky']) #shelter-section .scope-room-chip.selected {
  border-color: var(--shelter-light-chip-selected-border);
}
...
:global(:root[data-theme='milky']) #shelter-section .zone-scope-hint {
  border-color: var(--shelter-light-zone-hint-border);
  background: var(--shelter-light-zone-hint-bg);
  color: var(--shelter-light-zone-hint-text);
}
