...
export const PHONE_COMPONENT_REQUIREMENTS: readonly PhoneComponentRequirement[] = Object.freeze([
  ...
  Object.freeze({ id: 'phone.shell', label: '小手机-40手机外壳', version: '1.0.0', activation: 'ready' }),
  Object.freeze({ id: 'communication.apps', label: '小手机-50通信与情报APP', version: '1.0.0', activation: 'ready' }),
  ...
  Object.freeze({ id: 'winter.adapter', label: '小手机-90寒冬适配器', version: '1.1.0', activation: 'ready' }),
]);
