...
>>>>>>> fd8153baf11ced5360854b92fb17395299e83151:.agents/skills/mvu-variable-framework/SKILL.md
---
# MVU Beta 变量框架 ([MagVarUpdate](https://github.com/MagicalAstrogy/MagVarUpdate))

> **⚠️ MVU Beta 版本说明**：本文档描述的是 MVU Beta 版本。对于新的 MVU Zod 项目，请参考 [.cursor/rules/MVU组件包.mdc](MVU组件包.mdc)。

MVU Beta 变量框架是一个独立的酒馆助手脚本. 它作用于消息楼层变量, 允许酒馆角色卡作者在世界书中设置消息楼层变量, 在世界书或聊天记录中初始化消息楼层变量, 及用 AI 输出更新消息楼层变量.
