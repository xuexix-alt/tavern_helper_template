    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-5xl max-h-[90vh] flex flex-col bg-surface border border-primary/30 shadow-[0_0_30px_rgba(var(--primary-rgb),0.15)] clip-corner"
        >
          {/* Header */}
